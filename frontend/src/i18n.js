...
const resources = {
  zh: {
    translation: {
      ...
      // 密码强度要求
      "auth_pw_req_length": "8-20 个字符",
      "auth_pw_req_upper": "包含大写字母",
      "auth_pw_req_lower": "包含小写字母",
      "auth_pw_req_number": "包含数字",
      "auth_pw_req_special": "包含特殊字符 (@$!%*?&)",
  ...
  en: {
    translation: {
      ...
      "auth_pw_req_length": "8-20 characters",
      "auth_pw_req_upper": "Uppercase letters",
      "auth_pw_req_lower": "Lowercase letters",
      "auth_pw_req_number": "Numbers",
      "auth_pw_req_special": "Special characters (@$!%*?&)",
  ...
  jp: {
    translation: {
      ...
      "auth_pw_req_length": "8〜20文字",
      "auth_pw_req_upper": "大文字を含む",
      "auth_pw_req_lower": "小文字を含む",
      "auth_pw_req_number": "数字を含む",
      "auth_pw_req_special": "記号を含む (@$!%*?&)",
  ...
  fr: {
    translation: {
      ...
      "auth_pw_req_length": "8-20 caractères",
      "auth_pw_req_upper": "Lettre majuscule",
      "auth_pw_req_lower": "Lettre minuscule",
      "auth_pw_req_number": "Chiffre",
      "auth_pw_req_special": "Caractère spécial (@$!%*?&)",
  ...
  de: {
    translation: {
      ...
      "auth_pw_req_length": "8-20 Zeichen",
      "auth_pw_req_upper": "Großbuchstaben",
      "auth_pw_req_lower": "Kleinbuchstaben",
      "auth_pw_req_number": "Zahlen",
      "auth_pw_req_special": "Sonderzeichen (@$!%*?&)",
